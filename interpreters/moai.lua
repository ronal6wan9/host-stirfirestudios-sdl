...
[[xpcall(function() 
    ...
    %s
      ...
      -- move tmpfile for code to project dir for debugging host stirfire sdl
      local newfile = MergeFullPath(self:fworkdir(wfilename), tmpfile:GetName().."."..tmpfile:GetExt())
      os.execute("copy "..file.." "..newfile)
      file = newfile
